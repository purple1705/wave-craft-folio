...
import ModernCard from "@/components/animations/ModernCard";
import ModernTimeline from "@/components/animations/ModernTimeline";
    ...
    <section id="about" className="py-20 px-4 bg-background">
      <div className="max-w-6xl mx-auto">
        <ScrollReveal direction="up" className="text-center mb-16">
          <h2 className="text-4xl about-title md:text-5xl font-bold mb-4 bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">
            About Me
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto sub-title-about">
        ...
        <ModernTimeline staggerDelay={0.15} direction="up" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skills.map((skillGroup, index) => (
            <ModernCard 
              ...
              index={index}
            >
              <Card className="h-full border-border/50 bg-card/50 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 glass">
        ...
        <ScrollReveal direction="scale" delay={300} className="mt-16 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ModernCard delay={0.1}>
              <div className="space-y-2 p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl border border-primary/20">
